    ...
    <div className="min-h-[100vh] bg-[#050505] text-white pt-48 md:pt-56 pb-20 relative flex flex-col justify-center">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          {/* Right Side: Integrated Dispatch Form */}
          <motion.div 
            initial={{ opacity: 0, x: 40 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, delay: 0.4 }}
            className="bg-[#0a0a0a] border border-white/10 p-0 shadow-[0_30px_60px_rgba(0,0,0,0.8)] relative overflow-hidden h-[1300px] md:h-[1200px]"
          >
            <iframe 
